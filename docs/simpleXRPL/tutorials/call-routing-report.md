---
seo:
    description: Before submitting an operation, you can check how a given transactor would route for your account.
labels:
  - simpleXRPL
  - SDK
---
...
Before submitting an operation, you can check how a given transactor would route for your account.
