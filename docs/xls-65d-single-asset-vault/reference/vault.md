...
Because a `Vault` object cannot hold assets directly, a [pseudo-account](https://github.com/XRPLF/XRPL-Standards/discussions/191) holds assets on its behalf. This stand-alone account cannot receive funds or send transactions and exists solely to store assets.
