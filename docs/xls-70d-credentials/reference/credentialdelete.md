...
| `temINVALID_ACCOUNT_ID` | A provided `Subject` or `Issuer` field is invalid. For example, it contains [ACCOUNT_ZERO](https://xrpl.org/docs/concepts/accounts/addresses#special-addresses). |
...
[reserve requirement]: https://xrpl.org/docs/concepts/accounts/reserves#owner-reserves
