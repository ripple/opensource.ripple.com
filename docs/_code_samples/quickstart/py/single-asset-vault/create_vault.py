...
class SAVTestHarness:
    def __init__(self, master):
        ...
        ttk.Button(vault_owner_frame, text="Get Vault Owner Account", command=self.get_vault_owner_account, bootstyle=INFO + "-outline").grid(row=0, column=3, padx=5, pady=5, sticky="w")
        ...
        ttk.Button(vault_frame, text="Create Vault", command=self.create_vault, bootstyle=INFO).grid(row=0, column=2, padx=5, pady=5, sticky="ew")
        ttk.Button(vault_frame, text="Update Vault", command=self.update_vault, bootstyle=INFO).grid(row=1, column=2, padx=5, pady=5, sticky="ew")
        ttk.Button(vault_frame, text="Delete Vault", command=self.delete_vault, bootstyle=INFO).grid(row=2, column=2, padx=5, pady=5, sticky="ew")
        ttk.Button(vault_frame, text="Deposit", command=self.deposit, bootstyle=INFO + "-outline").grid(row=3, column=2, padx=5, pady=5, sticky="ew")
        ttk.Button(vault_frame, text="Withdraw", command=self.withdraw, bootstyle=INFO + "-outline").grid(row=4, column=2, padx=5, pady=5, sticky="ew")
    ...
    def get_vault_owner_account(self):
        ...
        self.vault_owner_xrp_balance_entry.insert(0, convert_drops_to_xrp(account_info['Balance']))
    ...
    def get_depositor_account(self):
        ...
        self.depositor_xrp_balance_entry.insert(0, convert_drops_to_xrp(account_info['Balance']))
    ...
    def create_vault(self):
        ...
        vault_owner_account = self.vault_owner_account_entry.get()
        vault = get_account_object(vault_owner_account, "VAULT")
